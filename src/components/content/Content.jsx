        ...
        <>
            <div className='contentStyle'>
                            ...
                            <Row>
                                {cardObject.map((element, index) => (
                                    <Col key={index} xs={12} lg={4} md={4}>
                                        <SkillCard number={element.number} title={element.title} text={element.text} />
                                    </Col>
                                ))}
                            </Row>
                        )}
                                ...
                                <Row>
                                    {experienceObject.map((element, index) => (
                                        <Col key={index} xs={12} lg={12} md={4}>
                                            <ExperienceCard title={element.title} subTitle={element.subTitle} text={element.text} year={element.year} />
                                        </Col>
                                    ))}
                                    <Col>
                                        <Button variant='light' style={{ width: '11rem', borderRadius: '50px', fontSize: '18px', fontWeight: 'bold', margin: '0% 2% 0% 15%' }} className=' p-2'>VIEW WORK</Button>
                                        <Button variant='dark' style={{ width: '11rem', borderRadius: '50px', fontSize: '18px', fontWeight: 'bold', border: '2px solid white' }} className='p-2'>VIEW RESUME</Button>
                                    </Col>
                                </Row>
                            )}
                    </div>
                ...
                <Container>
                    <Row>
                        <Col>
                        <p style={{marginLeft : '5%'}}>DESIGNED & BUILT FROM THE DESK OF <b>DEVANTA EBISON</b>
                            <span style={{float : 'right'}}>OLIO PORTFOLIO TEMPLATE (MIDNIGHT) – 2024© </span>
                        </p>
